...
# Ellenőrizzük, hogy a rendszer macOS (Darwin)-e
if platform.system() != "Darwin":
    print("Ez az installer csak macOS rendszeren használható!")
    sys.exit(1)
...
def main():
    # macOS esetén nem APPDATA, hanem a felhasználó home könyvtára alapján építjük fel az elérési útvonalakat
